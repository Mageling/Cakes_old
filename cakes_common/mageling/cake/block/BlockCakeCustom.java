...
public class BlockCakeCustom extends BlockCake {
    ...
    public void getEffect(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer) {
        TileEntityCakeCustom te = (TileEntityCakeCustom)par1World.getBlockTileEntity(par2, par3, par4);
